...
// - Referencing and Using ThermalLabelWebEditor-15.0.N.N.js
...
var UIEditor = {
    ...
    getGridSettings: function () {
        ...
        $("#gs_snap_to_items").prop('checked', tleditor.snap_to_items);
        $("#grid-settings").modal();
        return;
    },
    ...
    setGridSettings: function () {
        ...
        tleditor.snap_to_items = $("#gs_snap_to_items").prop('checked');
        this.closeModal();
    },
